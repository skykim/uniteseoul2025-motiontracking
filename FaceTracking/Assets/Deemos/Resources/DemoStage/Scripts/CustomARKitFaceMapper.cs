...
namespace Unity.LiveCapture.ARKitFaceCapture
{
    ...
    /// </remarks>
    public abstract class CustomARKitFaceMapper : ScriptableObject
    {
        /// <summary>
        ...
        public virtual FaceMapperCache CreateCache(CustomARKitFaceActor actor)
        {
            return null;
        }
